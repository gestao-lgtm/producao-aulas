...
import {
  BookOpen, Target, Users, Calendar, FileText, ChevronRight,
  Star, AlertCircle, Clock, Play
} from "lucide-react";
...
export default function LessonPage({ params }: { params: { id: string } }) {
  ...
  const currentStep = steps.find(s => s.status === "AGUARDANDO_APROVACAO" || s.status === "EM_ANDAMENTO");
      ...
      <main className="p-6">
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-5">
            ...
            {/* Current step alert */}
            {currentStep && currentStep.status === "AGUARDANDO_APROVACAO" && (
